...
function Action(props) {
  ...
  if (
    props.gameState.state == "Voting" ||
    props.gameState.state == "Selection" ||
    props.gameState.state == "Night"
  ) {
    return (
      <div className={styles.actionContainer}>
        <div className={styles.selectedContainer}>
          ...
          <div id={styles.usersSelected}>
            <div className={styles.selectedUser} style={{ display: "none" }}>
              User1
            </div>
            <div className={styles.selectedUser} style={{ display: "none" }}>
              User2
